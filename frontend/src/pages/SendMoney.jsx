  ...
  return (
    <div className="flex justify-center h-screen bg-gray-100">
      <div className="h-full flex flex-col justify-center">
        <div className="border border-gray-300 h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              {loading && (
                <p className="text-gray-500 text-center mt-2">Processing...</p>
              )}
            </div>
          </div>
        </div>
